...
const subjects = [
  ...
  { id: "S3", grade: 2, semester: 1, group: "기술·가정/\n정보", type:"일반", name: "기술·가정", credit: 3 },
  { id: "S4", grade: 2, semester: 1, group: "기술·가정/\n정보", type:"진로", name: "인공지능과\n 피지컬 컴퓨팅", credit: 3 },
  { id: "S5", grade: 2, semester: 1, group: "기술·가정/\n정보", type:"진로", name: "데이터 과학", credit: 3 },
  { id: "S6", grade: 2, semester: 1, group: "제2외국어/\n한문", type:"일반", name: "중국어", credit: 3 },
  { id: "S7", grade: 2, semester: 1, group: "제2외국어/\n한문", type:"일반", name: "일본어", credit: 3 },
  { id: "S8", grade: 2, semester: 1, group: "사회\n(역사/도덕 포함)", type:"일반", name: "세계사", credit: 3 },
  { id: "S9", grade: 2, semester: 1, group: "사회\n(역사/도덕 포함)", type:"진로", name: "정치", credit: 3 },
  { id: "S10", grade: 2, semester: 1, group: "사회\n(역사/도덕 포함)", type:"일반", name: "현대사회와 윤리", credit: 3 },
  { id: "S11", grade: 2, semester: 1, group: "사회\n(역사/도덕 포함)", type:"진로", name: "도시의 미래 탐구", credit: 3 },
  ...
  { id: "S18", grade: 2, semester: 2, group: "기술·가정/\n정보", type:"융합", name: "소프트웨어와 생활", credit: 3 },  
  { id: "S19", grade: 2, semester: 2, group: "기술·가정/\n정보", type:"진로", name: "인공지능 기초", credit: 3 },  
  { id: "S20", grade: 2, semester: 2, group: "기술·가정/\n정보", type:"융합", name: "창의 공학 설계", credit: 3 },  
  { id: "S21", grade: 2, semester: 2, group: "제2외국어/\n한문", type:"융합", name: "중국 문화", credit: 3 },  
  { id: "S22", grade: 2, semester: 2, group: "제2외국어/\n한문", type:"융합", name: "일본 문화", credit: 3 },  
  { id: "S23", grade: 2, semester: 2, group: "사회\n(역사/도덕 포함)", type:"진로", name: "동아시아\n 역사 기행", credit: 3 },  
  { id: "S24", grade: 2, semester: 2, group: "사회\n(역사/도덕 포함)", type:"진로", name: "법과 사회", credit: 3 },  
  { id: "S25", grade: 2, semester: 2, group: "사회\n(역사/도덕 포함)", type:"융합", name: "여행지리", credit: 3 },  
  { id: "S26", grade: 2, semester: 2, group: "사회\n(역사/도덕 포함)", type:"융합", name: "윤리문제 탐구", credit: 3 },  
  ...
  { id: "S34", grade: 3, semester: 1, group: "기술·가정/\n정보", type:"진로", name: "정보과학", credit: 3 },  
  { id: "S35", grade: 3, semester: 1, group: "사회\n(역사/도덕 포함)", type:"일반", name: "세계시민과 지리", credit: 3 },  
  { id: "S36", grade: 3, semester: 1, group: "사회\n(역사/도덕 포함)", type:"진로", name: "경제", credit: 3 },  
  { id: "S37", grade: 3, semester: 1, group: "사회\n(역사/도덕 포함)", type:"진로", name: "윤리와 사상", credit: 3 },  
  { id: "S38", grade: 3, semester: 1, group: "사회\n(역사/도덕 포함)", type:"융합", name: "역사로 탐구하는\n 현대 세계", credit: 3 },  
  { id: "S39", grade: 3, semester: 1, group: "사회\n(역사/도덕 포함)", type:"융합", name: "사회문제 탐구", credit: 3 },  
  ...
  { id: "S46", grade: 3, semester: 2, group: "사회\n(역사/도덕 포함)", type:"진로", name: "인문학과 윤리", credit: 3 },  
  { id: "S47", grade: 3, semester: 2, group: "사회\n(역사/도덕 포함)", type:"융합", name: "금융과 경제생활", credit: 3 }, 
  { id: "S48", grade: 3, semester: 2, group: "사회\n(역사/도덕 포함)", type:"융합", name: "기후변화와 지속가능한 세계", credit: 3 }, 
  ...
  { id: "S51", grade: 3, semester: 2, group: "교양", type:"진로", name: "인문학적 감성과\n 역사 이해", credit: 3 }, 
  { id: "S52", grade: 3, semester: 2, group: "과학", type:"융합", name: "과학의 역사와 문화", credit: 3 }, 
  { id: "S53", grade: 3, semester: 2, group: "과학", type:"융합", name: "기후변화와\n 환경생태", credit: 3 }, 
  { id: "S54", grade: 3, semester: 2, group: "과학", type:"융합", name: "융합과학 탐구", credit: 3 }, 
  { id: "S55", grade: 3, semester: 2, group: "기술·가정/\n정보", type:"진로", name: "사물인터넷", credit: 3 }, 
...
한문, 교양 교과(군) 학점 충족<br>`;
    ...
    return `❌ 기술·가정/
정보, 제2외국어/
한문, 교양 교과(군) ${16-selected_total}학점 부족<br>`;
  }
}
